...
const Services = () => {
  const [activeService, setActiveService] = useState<ServiceModalData | null>(
    null,
  );
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">
            Complete Driving & Licensing Solutions
          </h2>

          <p className="text-gray-500 text-sm max-w-xl mx-auto leading-relaxed">
            Professional driving training, driver&apos;s license processing,
            vehicle licensing, defensive driving courses, expert driver
            services, and GPS vehicle tracking all in one place.
          </p>
        </div>
